...
public class Route {
    ...
    public int getCongestion() {
        return new AveragingCongestionCalculator(sensors).calculateCongestion();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!id.equals(((Route) obj).id) || defaultSpeed != ((Route) obj).defaultSpeed) {
            return false;
        }

        if (!((trafficLight == null && ((Route) obj).trafficLight == null) ||
                (trafficLight != null && ((Route) obj).trafficLight != null))) {
            return false;
        }

        if (trafficLight != null && ((Route) obj).trafficLight != null &&
            trafficLight.getSignal() != ((Route) obj).trafficLight.getSignal()) {
            return false;
        }

        if (!(speedSign == null && ((Route) obj).speedSign == null) ||
            (speedSign != null && ((Route) obj).speedSign != null)) {
            return false;
        }

        if (speedSign != null && ((Route) obj).speedSign != null &&
                speedSign.getCurrentSpeed() != ((Route) obj).speedSign.getCurrentSpeed()) {
            return false;
        }

        return sensors.containsAll(((Route) obj).sensors);
    }
