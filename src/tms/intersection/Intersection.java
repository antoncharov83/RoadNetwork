...
public class Intersection {
    ...
    public void addTrafficLights​(List<Route> order,
        ...
        if (yellowTime < 1) {
            throw new IllegalArgumentException("The traffic light yellow time is less than one (1) second");
        }

        if (duration < yellowTime + 1) {
            throw new IllegalArgumentException("The traffic light duration is less" +
                    " than the given yellowTime plus one (1) second");
        }
        ...
        if (!incomingConnections.containsAll(order) ||
                incomingConnections.size() != order.size()) {
            throw new InvalidOrderException("The given order is not a permutation of incomingRoutes");
        }
    ...
    public boolean equals(Object obj) {
        ...
        return id.equals(((Intersection) obj).getId());
    }
    ...
    public String toString() {
        String result = id;
        if (hasTrafficLights()) {
            result += intersectionLights.toString();
        }
        return result;
    }
}
